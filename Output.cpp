...
OpenAvrilConcurrency::Object* OpenAvrilConcurrency::Output::dyn_REG_get_Item0_PraiseOutputSubset()
{
    auto temp = stat_REG_get_ptr_Item0_PraiseOutputSubset()->begin();
    std::advance(temp, 0);
    return *temp;
}
...
void OpenAvrilConcurrency::Output::dyn_REG_set_Item0_PraiseOutputSubset(OpenAvrilConcurrency::Praise0_Output* objPraiseSubset)
{
    auto temp = stat_REG_get_ptr_Item0_PraiseOutputSubset()->begin();
    std::advance(temp, 0);
...
{
    _REG_ptr_List_Of_PraiseOutputSubset = new std::list<class OpenAvrilConcurrency::Object*>();
    while (stat_REG_get_ptr_Item0_PraiseOutputSubset() == NULL) {}
    stat_REG_get_ptr_Item0_PraiseOutputSubset()->resize(uint8_t(1));
    auto temp = stat_REG_get_ptr_Item0_PraiseOutputSubset()->begin();
...
std::list<OpenAvrilConcurrency::Object*>* OpenAvrilConcurrency::Output::stat_REG_get_ptr_Item0_PraiseOutputSubset()
{
