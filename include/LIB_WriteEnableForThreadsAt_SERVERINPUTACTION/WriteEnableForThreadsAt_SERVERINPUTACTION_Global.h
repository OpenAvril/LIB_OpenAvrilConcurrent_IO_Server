...
namespace OpenAvrilCLIBWriteEnableForThreadsAtSERVERINPUTACTION
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_SERVERINPUTACTION_Global();
        static void stat_boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_SERVERINPUTACTION_Global();
        static void stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SERVERINPUTACTION_Global();
        ...
        void dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_SERVERINPUTACTION_Global(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj);
        void dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_SERVERINPUTACTION_Global(class WriteEnableForThreadsAt_SERVERINPUTACTION_Framework* obj);
