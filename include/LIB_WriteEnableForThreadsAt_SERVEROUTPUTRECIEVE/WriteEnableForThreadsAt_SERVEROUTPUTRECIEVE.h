...
namespace OpenAvrilCLIBWriteEnableForThreadsAtSERVEROUTPUTRECIEVE
{
    ...
    public:
        ...
        static void stat_boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE();
        static void stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE();
        ...
        void dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE(class WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj);
        void dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE(class WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj);
