...
namespace OpenAvrilCLIBWriteEnableForThreadsAtSERVEROUTPUTRECIEVE
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control();
        static void stat_boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control();
        static void stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control();
        ...
        void dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control(class WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj);
        void dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Control(class WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj);
