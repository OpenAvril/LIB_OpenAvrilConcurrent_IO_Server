...
namespace OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER
{
    ...
    public:
        ...
        ~LaunchEnableForConcurrentThreadsAt_SERVER_Global();
        static void stat_boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_STACK_Global();
        static void stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_STACK_Global();
        ...
        void dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_STACK_Global();
        void dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_STACK_Global();
        ...
        static class LaunchEnableForConcurrentThreadsAt_SERVER_Framework* stat_CONVERT_Obj_To_ClassOf(void* obj);
    private:
