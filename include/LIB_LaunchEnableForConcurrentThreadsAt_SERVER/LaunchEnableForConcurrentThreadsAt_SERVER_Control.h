...
namespace OpenAvrilCLIBLaunchEnableForConcurrentThreadsAtSERVER
{
    ...
    public:
        ...
        static void stat_boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_STACK_Control();
        static void stat_CLASS_boot1_DEFINE_WriteEnableForThreadsAt_STACK_Control();
        ...
        void dyn_REG_boot1_DEFINE_WriteEnableForThreadsAt_STACK_Control();
        void dyn_REG_boot2_SUBSTANTIATE_WriteEnableForThreadsAt_STACK_Control();
