...
// constructor.
    OpenAvrilConcurrency::Server::Server()
    {
        ...
        stat_create_CLASS_ptr_Global();
        while (stat_get_CLASS_ptr_Global() == NULL) {}
        std::cout << "alpha." << std::endl;
        stat_create_CLASS_ptr_Algorithms();
        while (stat_get_CLASS_ptr_Algorithms() == NULL) {}
        std::cout << "bravo." << std::endl;
        stat_create_CLASS_ptr_Data();
        while (stat_get_CLASS_ptr_Data() == NULL) {}
        std::cout << "charlie." << std::endl;
        stat_get_CLASS_ptr_Data()->initialise_Control();
        std::cout << "delta." << std::endl;
        stat_create_CLASS_ptr_Execute();
        while (stat_get_CLASS_ptr_Execute() == NULL) {}
        std::cout << "echo." << std::endl;
        stat_get_CLASS_ptr_Execute()->initialise_Control(stat_get_CLASS_ptr_Global()->get_REG_Item_number_Of_Implemented_Cores());
...
// private.
    // dynamic.
        ...
        // set.
    // static.
    void OpenAvrilConcurrency::Server::stat_create_CLASS_ptr_Algorithms()
    {
        static class OpenAvrilConcurrency::Algorithms* _CLASS_ptr_Algorithms = new class OpenAvrilConcurrency::Algorithms();
        while (stat_get_CLASS_ptr_Algorithms() == NULL) {}
    }
    void OpenAvrilConcurrency::Server::stat_create_CLASS_ptr_Data()
    {
        static class OpenAvrilConcurrency::Data* _CLASS_ptr_Data = new class OpenAvrilConcurrency::Data();
        while (stat_get_CLASS_ptr_Data() == NULL) {}
    }
    void OpenAvrilConcurrency::Server::stat_create_CLASS_ptr_Execute()
    {
        static class OpenAvrilConcurrency::Execute* _CLASS_ptr_Execute = new class OpenAvrilConcurrency::Execute();
        while (stat_get_CLASS_ptr_Execute() == NULL) {}
    }
    void OpenAvrilConcurrency::Server::stat_create_CLASS_ptr_Global()
    {
        static class OpenAvrilConcurrency::Global* _CLASS_ptr_Global = new class OpenAvrilConcurrency::Global();
        while (stat_get_CLASS_ptr_Global() == NULL) {}
    }
        // get.
    OpenAvrilConcurrency::Algorithms* OpenAvrilConcurrency::Server::stat_get_CLASS_ptr_Algorithms()
    {
        return _CLASS_ptr_Algorithms;
    }
    OpenAvrilConcurrency::Data* OpenAvrilConcurrency::Server::stat_get_CLASS_ptr_Data()
    {
        return _CLASS_ptr_Data;
    }
    OpenAvrilConcurrency::Execute* OpenAvrilConcurrency::Server::stat_get_CLASS_ptr_Execute()
    {
        return _CLASS_ptr_Execute;
    }
    OpenAvrilConcurrency::Global* OpenAvrilConcurrency::Server::stat_get_CLASS_ptr_Global()
    {
