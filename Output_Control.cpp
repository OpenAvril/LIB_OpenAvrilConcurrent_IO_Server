...
// public.
	...
	void OpenAvrilConcurrency::Output_Control::selectset_Output_Subset(OpenAvrilConcurrency::Framework_Server* obj, uint8_t praiseEventId, uint8_t concurrent_threadID)
	{
		...
		{
		case 0:
			obj->get_CLASS_ptr_Server()->get_ptr_CLASS_Data()->stat_get_ptr_Item_array_Of_doubleBuffer_Output_WRITE()->set_Subset_With_OutputSubet(obj->get_CLASS_ptr_Server()->get_ptr_CLASS_Data()->get_ptr_User_Output()->get_ptr_Praise0_Output()); 
			break;
		}
	}
	// static.
