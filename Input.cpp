...
// public.
    ...
    {
        stat_REG_set_ptr_Item_PraiseInputSubset(obj->dyn_CLASS_get_ptr_Server()->dyn_CLASS_get_ptr_Data()->dyn_CLASS_get_ptr_User_Input()->get_CLASS_ptr_Item_ptr_PraiseInputSubsets(0));
    }
        // get.
    ...
    OpenAvrilConcurrency::Object* OpenAvrilConcurrency::Input::dyn_REG_get_ptr_Item_On_List_Of_PraiseInputSubset()
    {
