...
// registers.
    ...
    std::list<OpenAvril::Object*> _list_Of_Praise_Subsets = { NULL };

// pointers.
    std::list<OpenAvril::Object*>* _ptr_list_Of_Praise_Subsets = NULL;
...
// destructor.
    OpenAvril::Input::~Input()
    {
        ...
        delete _ptr_list_Of_Praise_Subsets;
    }
...
// private.
    ...
    void OpenAvril::Input::create_list_Of_Praise_Subsets()
    {
        std::list<OpenAvril::Object*> _list_Of_Praise_Subsets = { NULL, NULL, NULL };
        std::list<OpenAvril::Object*>* _ptr_list_Of_Praise_Subsets = new std::list<class OpenAvril::Object*>(3);//NUMBER OF PRAISES.
        while(_ptr_list_Of_Praise_Subsets == NULL) { }
        for (__int8 praiseID = 0; praiseID < sizeof(_list_Of_Praise_Subsets); praiseID++)
        {
            while (get_ptr_Item_On_list_Of_Praise_Subsets(praiseID) == NULL) {}
            auto temp1 = _ptr_list_Of_Praise_Subsets->begin();
            std::advance(temp1, praiseID);
            auto temp2 = _list_Of_Praise_Subsets.begin();
            std::advance(temp2, praiseID);
            temp2 = temp1;
        }
        create_ptr_list_Of_Praise_Subsets();
    ...
    void OpenAvril::Input::create_ptr_list_Of_Praise_Subsets()
    {
        _ptr_list_Of_Praise_Subsets = &_list_Of_Praise_Subsets;
    }
    // get.
    __int8 OpenAvril::Input::get_lenght_Of_list_Of_Praise_Subsets()
    {
        return sizeof(_list_Of_Praise_Subsets);
    }
    class OpenAvril::Object* OpenAvril::Input::get_ptr_Item_On_list_Of_Praise_Subsets(__int8 praiseID)
    {
        auto temp = _ptr_list_Of_Praise_Subsets->begin();
