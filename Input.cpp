...
// public.
    ...
    {
        stat_REG_set_ptr_Item_PraiseInputSubset(0, obj->dyn_CLASS_get_ptr_Server()->dyn_CLASS_get_ptr_Data()->dyn_CLASS_get_ptr_User_Input()->get_CLASS_ptr_Item_ptr_PraiseInputSubsets(0));
    }
        // get.
