...
// public.
    ...
    // dynamic.
        // create.
    void OpenAvrilConcurrency::Global::app_REG_initialise_Item_number_Of_Implemented_Cores(uint8_t* newINITIALISED_Value)
    {
        stat_REG_set_Item_number_Of_Implemented_Cores(*newINITIALISED_Value);
    }
    void OpenAvrilConcurrency::Global::app_REG_initialise_Item_number_Of_Praise_Events(uint8_t* newINITIALISED_Value)
    {
