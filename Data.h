...
// public.
    // dynamic.
        ...
        void initialise_REG_Item_On_array_Of_doubleBuffer_Input(class Framework_Server* obj, class OpenAvrilConcurrency::Input* newINITIALISED_Input);
        void initialise_REG_Item_On_array_Of_doubleBuffer_Output(class Framework_Server* obj, class OpenAvrilConcurrency::Output* newINITIALISED_Output);
        void initialise_REG_Item_On_vector_Of_stack_Of_InputPraise(class Framework_Server* obj, class OpenAvrilConcurrency::Input* newINITIALISED_Input);
        void initialise_REG_Item_On_vector_Of_stack_Of_OutputPraise(class Framework_Server* obj, class OpenAvrilConcurrency::Output* newINITIALISED_Output);
        // get.
...
// private.
    ...
    // static.
        ...
        static void stat_REG_create_ptr_array_Of_doubleBuffer_Input(class Framework_Server* obj, Input* newDEFAULT_Input);
        static void stat_REG_create_ptr_array_Of_doubleBuffer_Output(class Framework_Server* obj, Output* newDEFAULT_Input);
        static void stat_REG_create_ptr_vector_Of_stack_Of_InputPraise(class Framework_Server* obj, Input* newDEFAULT_Input);
        static void stat_REG_create_ptr_vector_Of_stack_Of_OutputPraise(class Framework_Server* obj, Output* newDEFAULT_Output);
            // get.
        static class Input* stat_REG_get_ptr_Item_Of_list_Of_ptr_array_Of_buffer_Input_ReferenceForThread(uint8_t concurrentThreadID, OpenAvrilConcurrency::Input* newINITIALISED_Input);
        static class Output* stat_REG_get_ptr_Item_Of_list_Of_ptr_array_Of_buffer_Output_ReferenceForThread(uint8_t concurrentThreadID, OpenAvrilConcurrency::Output* newINITIALISED_Output);
