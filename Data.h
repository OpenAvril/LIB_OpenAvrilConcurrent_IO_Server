...
// private.
    ...
    // static.
        ...
        static class Input* stat_REG_get_ptr_Item_array_Of_doubleBuffer_Input_READ(class Framework_Server* obj, class Input* newCLass);
        static class Input* stat_REG_get_ptr_Item_array_Of_doubleBuffer_Input_WRITE(class Framework_Server* obj, class Input* newCLass);
        static class Output* stat_REG_get_ptr_Item_array_Of_doubleBuffer_Output_READ(class Framework_Server* obj, class Output* newCLass);
        static class Output* stat_REG_get_ptr_Item_array_Of_doubleBuffer_Output_WRITE(class Framework_Server* obj, class Output* newCLass);
        ...
        static void stat_REG_set_ptr_Item_On_vector_Of_stack_Of_InputPraise(class Framework_Server* obj, class Input* newCLass);
        static void stat_REG_set_ptr_Item_On_vector_Of_stack_Of_OutputPraise(class Framework_Server* obj, class Output* newCLass);
        static std::array<class Input*, 3>* stat_REG_set_ptr_array_Of_buffer_Input_ReferenceForThread();//NUMBER OF CONCURRENT THREADS.
        static std::array<class Output*, 3>* stat_REG_set_ptr_array_Of_buffer_Output_ReferenceForThread();//NUMBER OF CONCURRENT THREADS.
        static std::array<class Input*, 2>* stat_REG_set_ptr_array_Of_doubleBuffer_Input();
        static std::array<class Output*, 2>* stat_REG_set_ptr_array_Of_doubleBuffer_Output();
        static std::vector<class Input*>* stat_REG_set_ptr_vector_Of_stack_Of_InputPraise();
        static std::vector<class Output*>* stat_REG_set_ptr_vector_Of_stack_Of_OutputPraise();
    };
}
