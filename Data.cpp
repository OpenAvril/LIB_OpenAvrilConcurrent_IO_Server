...
// pointers.
    ...
    // registers.
    static std::array<class OpenAvrilConcurrency::Input*, 3>* _stat_REG_ptr_array_Of_buffer_Input_ReferenceForThread = NULL;//NUMBER OF CONCURRENT THREADS.
    static std::array<class OpenAvrilConcurrency::Output*, 3>* _stat_REG_ptr_array_Of_buffer_Output_ReferenceForThread = NULL;//NUMBER OF CONCURRENT THREADS.
    static std::array<class OpenAvrilConcurrency::Input*, 2>* _stat_REG_ptr_array_Of_doubleBuffer_Input = NULL;
    static std::array<class OpenAvrilConcurrency::Output*, 2>* _stat_REG_ptr_array_Of_doubleBuffer_Output = NULL;
    static std::vector<class OpenAvrilConcurrency::Input*>* _stat_REG_ptr_vector_Of_stack_Of_InputPraise = NULL;
    static std::vector<class OpenAvrilConcurrency::Output*>* _stat_REG_ptr_vector_Of_stack_Of_OutputPraise = NULL;
...
// public.
    ...
    {
        auto temp = stat_get_ptr_REG_array_Of_doubleBuffer_Input()->begin();
    ...
    {
        auto temp = stat_REG_get_ptr_array_Of_doubleBuffer_Output()->begin();
        std::advance(temp, sideRW);
    ...
    {
        stat_set_ptr_Item_array_Of_doubleBuffer_Input_WRITE(obj->get_CLASS_ptr_Server()->get_CLASS_ptr_Data()->get_CLASS_ptr_Data_Control()->get_STATE_Of_READ_For_array_Of_doubleBuffer_Input());
    }
    ...
    {
        auto temp = stat_get_ptr_REG_array_Of_doubleBuffer_Input()->begin();
        std::advance(temp, obj->get_CLASS_ptr_Server()->get_CLASS_ptr_Data()->get_CLASS_ptr_Data_Control()->get_STATE_Of_WRITE_For_array_Of_doubleBuffer_Input());
        return *temp;
    }
    ...
    {
        auto temp = stat_REG_get_ptr_array_Of_doubleBuffer_Output()->begin();
        std::advance(temp, obj->get_CLASS_ptr_Server()->get_CLASS_ptr_Data()->get_CLASS_ptr_Data_Control()->get_STATE_Of_READ_For_array_Of_doubleBuffer_Output());
        return *temp;
    }
    ...
    {
        auto temp = stat_REG_get_ptr_array_Of_doubleBuffer_Output()->begin();
        std::advance(temp, obj->get_CLASS_ptr_Server()->get_CLASS_ptr_Data()->get_CLASS_ptr_Data_Control()->get_STATE_Of_WRITE_For_array_Of_doubleBuffer_Output());
        return *temp;
    }
    ...
    {
        return stat_REG_get_ptr_array_Of_buffer_Input_ReferenceForThread();
    }
    ...
    {
        return stat_REG_get_ptr_array_Of_buffer_Output_ReferenceForThread();
    }
...
// private.
    ...
    {
        std::array<class OpenAvrilConcurrency::Input*, 2>* _stat_REG_ptr_array_Of_doubleBuffer_Input = new std::array<class OpenAvrilConcurrency::Input*, 2>();
        while (stat_get_ptr_REG_array_Of_doubleBuffer_Input() == NULL) {}
        *_stat_REG_ptr_array_Of_doubleBuffer_Input = { newDEFAULT_Input, newDEFAULT_Input };
    }
    ...
    {
        std::array<class OpenAvrilConcurrency::Output*, 2>* _stat_REG_ptr_array_Of_doubleBuffer_Output = new std::array<class OpenAvrilConcurrency::Output*, 2>();
        while (stat_REG_get_ptr_array_Of_doubleBuffer_Output() == NULL) {}
        *_stat_REG_ptr_array_Of_doubleBuffer_Output = { newDEFAULT_Output, newDEFAULT_Output };
    }
    ...
    {
        std::array<class OpenAvrilConcurrency::Input*, 3>* _stat_REG_ptr_array_Of_doubleBuffer_Input = new std::array<class OpenAvrilConcurrency::Input*, 3>();//NUMBER Of CONCURRENT THREADS.
        while (stat_REG_get_ptr_array_Of_buffer_Input_ReferenceForThread() == NULL) {}
        *_stat_REG_ptr_array_Of_doubleBuffer_Input = { newDEFAULT_Input, newDEFAULT_Input, newDEFAULT_Input };//NUMBER OF CONCURRENT THREADS.
    }
    ...
    {
        std::array<class OpenAvrilConcurrency::Output*, 3>* _stat_REG_ptr_array_Of_doubleBuffer_Output = new std::array<class OpenAvrilConcurrency::Output*, 3>();//NUMBER OF CONCURRENT THREADS.
        while (stat_REG_get_ptr_array_Of_buffer_Output_ReferenceForThread() == NULL) {}
        *_stat_REG_ptr_array_Of_doubleBuffer_Output = { newDEFAULT_Output, newDEFAULT_Output, newDEFAULT_Output };//NUMBER OF CONCURRENT THREADS.
    }
    ...
    {
        std::vector<class OpenAvrilConcurrency::Input*>* _stat_REG_ptr_vector_Of_stack_Of_InputPraise = new std::vector<class OpenAvrilConcurrency::Input*>();
        while (stat_REG_get_ptr_vector_Of_stack_Of_InputPraise() == NULL) { }
        *_stat_REG_ptr_vector_Of_stack_Of_InputPraise = { newDEFAULT_Input };
    }
    ...
    {
        std::vector<class OpenAvrilConcurrency::Output*>* _stat_REG_ptr_vector_Of_stack_Of_OutputPraise = new std::vector<class OpenAvrilConcurrency::Output*>();
        while (stat_REG_get_ptr_vector_Of_stack_Of_OutputPraise() == NULL) { }
        *_stat_REG_ptr_vector_Of_stack_Of_OutputPraise = { newDEFAULT_Output };
    }
    ...
    std::array<class OpenAvrilConcurrency::Input*, 2>* OpenAvrilConcurrency::Data::stat_get_ptr_REG_array_Of_doubleBuffer_Input()
    {
