...
// pointers.
    // classes.
    class OpenAvrilConcurrency::Data_Control* _stat_CLASS_ptr_Data_Control = NULL;
    class OpenAvrilConcurrency::User_Input* _stat_CLASS_ptr_User_Input = NULL;
    class OpenAvrilConcurrency::User_Output* _stat_CLASS_ptr_User_Output = NULL;
    // registers.
