...
// pointers.
	// classes.
	// registers.
	static bool* _REG_ptr_flag_is_SystemInitialised = NULL;
	static std::array<bool, 4>* _REG_ptr_list_Of_flag_ThreadInitialised = { NULL };//NUMBER OF THREADS
...
// private.
	...
	{
		return _REG_ptr_list_Of_flag_ThreadInitialised;
	}
		// set.
